...
class ScheduledMeetingTest {
    ...
    @Test
    public void test_intersectWorkingTime_intersectionToTheWest() {
    ...
    @Test
    public void test_intersectWorkingTime_intersectionToTheEast() {
        ZoneId zone1 = ZoneId.of("Europe/Berlin");
    ...
    @Test
    public void test_intersectWorkingTime_timeOnBorderOf2Days() {
        ZoneId zone1 = ZoneId.of("Europe/Berlin");
        ZoneId zone2 = ZoneId.of("Europe/Moscow");
    ...
    @Test
    public void test_intersectWorkingTime_noIntersection() {
        ZoneId zone1 = ZoneId.of("Europe/Berlin");
    ...
    @Test
    public void test_intersectWorkingTime_borderCase() {
    ...
    @Test
    public void test_intersectWorkingTime_borderCase_ViceVersa() {
        ZoneId zone1 = ZoneId.of("Asia/Kamchatka");
        ZoneId zone2 = ZoneId.of("US/Alaska");
        LocalTime start1 = LocalTime.of(22, 0);
        LocalTime start2 = LocalTime.of(22, 0);
        int res = meeting.intersectWorkingTime(start1, 8, zone1, start2, 8, zone2);
        assertEquals(5, res);
    }

    @Test
    public void test_intersectWorkingTime_sameTimeZone() {
        ZoneId zone1 = ZoneId.of("Europe/Berlin");
    ...
    public void test_intersectWorkingTime2_timeOnBorderOf2Days() {
        ...
        LocalTime start1 = LocalTime.of(22, 0);
        LocalTime start2 = LocalTime.of(23, 0);
        int res = meeting.intersectWorkingTime2(start1, 8, zone1, start2, 9, zone2);
        //  assertEquals(8, res);
    }
