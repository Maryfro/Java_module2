...
class LoanIssuerTest {
    ...
    LoanConsumer lc5 = new LoanConsumer("Max", 18, 20000);
    LoanConsumer lc6 = new LoanConsumer("Max", 69, 20001);
    LoanConsumer lc7 = new LoanConsumer("Max", 69, 20000);
    LoanConsumer lc8 = new LoanConsumer("Max", 70, 20000);
    LoanConsumer lc9 = new LoanConsumer("Max", 50, 20001);
    LoanConsumer lc10 = new LoanConsumer("Max", 50, 20000);
